# variables.tf - Input Variables for Hermes Proxmox Configuration
#
...
variable "container_ip" {
  description = "Static IP address in CIDR notation (e.g., '10.0.50.17/24'). Leave empty for DHCP."
  type        = string
  default     = "10.0.50.17/24"
}
