# variables.tf - Input Variables for n8n Terraform Configuration
...
variable "container_disk_gb" {
  description = "Disk size to allocate to the container in gigabytes (default: 20GB)"
  type        = number
  default     = 20
...
variable "tags" {
  ...
  type        = list(string)
  default     = ["n8n", "automation", "workflow"]
}
